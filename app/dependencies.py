...
#
# from app.config.env_config import load_env
# from app.core.embeddings import init_embedding_model
# from app.core.chunking import init_text_splitters
...
#     text_splitter_init_task = asyncio.create_task(init_text_splitters())
